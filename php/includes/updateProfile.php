    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($userName || $email)){
            ...
            require_once ('config.php');
                ...
                //query for updating employee details 
                $sql = "UPDATE employees SET first_name = '$fname', last_name = '$lname', NIC = '$NIC', contactNo = '$contact', email = '$email' WHERE username = '$uName'";
